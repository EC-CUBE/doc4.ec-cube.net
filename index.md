...
|掲載日|内容|
|---|---|
|2019/12/19|昇進者向けの[Webインストーラでのインストール方法](/quickstart_install/web-installer)のページが追加されました。| 
|2019/11/28|本体インストール方法に[「Docker Composeを使用してインストールする」](/quickstart_install#docker-composeを使用してインストールする)が追加されました。| 
|2019/11/21|「本体開発に参加する」セクションが追加されました。| 
|2019/11/19|各ページにリアクション/コメントができるように機能追加しました。| 
|2019/11/19|サイトのデザインを刷新しました。| 
