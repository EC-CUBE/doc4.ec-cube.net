...
※ 4.0.0, 4.0.1, 4.0.2 は、PHP7.3で動作いたしません。PHP7.3をご利用の場合、4.0.3以降のバージョンをご使用ください。
※ 4.0.0, 4.0.1, 4.0.2, 4.0.3 は、PHP7.4で動作いたしません。PHP7.4をご利用の場合、4.0.4以降のバージョンをご使用ください。

[EC-CUBE本体のバージョンアップ方法はこちら](/update)
