...
| お届け先追加 | mypage_delivery_new |  | 10回/30分 | ログイン後の画面のため、会員ベースのみ |
| お届け先編集 | mypage_delivery_edit |  | 10回/30分 | ログイン後の画面のため、会員ベースのみ |
| お届け先削除 | mypage_delivery_delete |  | 10回/30分 | ログイン後の画面のため、会員ベースのみ |
